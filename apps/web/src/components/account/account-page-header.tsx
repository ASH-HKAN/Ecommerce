...
type Props = {
  /** Optional translation key. If provided, takes precedence over `eyebrow`. */
  eyebrowKey?: TKey;
  eyebrow?: string;
  /** Optional translation key. If provided, takes precedence over `title`. */
  titleKey?: TKey;
  title?: string;
  /** Optional translation key. If provided, takes precedence over `description`. */
  descriptionKey?: TKey;
  description?: string;
  /** Params interpolated into the eyebrow/title/description translations. */
